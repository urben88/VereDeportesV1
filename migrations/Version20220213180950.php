 ...
 */
final class Version20220213180950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE solicita CHANGE id_usuario_id id_usuario_id INT DEFAULT NULL, CHANGE id_equipo_id id_equipo_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE solicita CHANGE id_usuario_id id_usuario_id INT NOT NULL, CHANGE id_equipo_id id_equipo_id INT NOT NULL');
