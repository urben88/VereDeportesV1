 ...
 */
final class Version20220218124120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liga ADD status TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liga DROP status, CHANGE deporte deporte VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nombre_liga nombre_liga VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
